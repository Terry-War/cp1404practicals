...
def run_tests():
    ...
    print(repeat_string("hi", 2))  # testing to see if it works
    ...
    car = Car(fuel=10)
    assert car.fuel == 10, "Car has set fuel correctly"
...
#  added a >= to the return statement

# 5. Write and test a function to format a phrase as a sentence.starting with a capital and ending with a single full stop.
